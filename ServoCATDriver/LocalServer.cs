...
namespace ASCOM.LocalServer {
    public static class Server {
        ...
        private static string localServerAppId = "{289163c8-6579-4b32-90d2-68fb447a01df}"; // Our AppId
        ...
        private static void RegisterObjects() {
            ...
            try {
                ...
                MessageBox.Show("Error while registering the server:\n" + ex.ToString(), "ASCOM.Joko.ServoCAT.Telescope", MessageBoxButtons.OK, MessageBoxIcon.Stop);
                return;
            }
        ...
        private static void ElevateSelf(string argument) {
            ...
            try {
                ...
                TL.LogMessage("IsAdministrator", $"The ASCOM.Joko.ServoCAT.Telescope was not " + (argument == "/register" ? "registered" : "unregistered because you did not allow it."));
                MessageBox.Show("The ASCOM.Joko.ServoCAT.Telescope was not " + (argument == "/register" ? "registered" : "unregistered because you did not allow it.", "ASCOM.Joko.ServoCAT.Telescope", MessageBoxButtons.OK, MessageBoxIcon.Warning));
            } catch (Exception ex) {
                TL.LogMessageCrLf("IsAdministrator", $"Exception: {ex}");
                MessageBox.Show(ex.ToString(), "ASCOM.Joko.ServoCAT.Telescope", MessageBoxButtons.OK, MessageBoxIcon.Stop);
            }
            return;
        }
        ...
        private static bool RegisterClassFactories() {
            ...
            foreach (Type driverType in driverTypes) {
                ...
                if (!factory.RegisterClassObject()) {
                    ...
                    MessageBox.Show("Failed to register class factory for " + driverType.Name, "ASCOM.Joko.ServoCAT.Telescope", MessageBoxButtons.OK, MessageBoxIcon.Stop);
                    return false;
                }
            ...
            if (args.Length > 0) {
                switch (args[0].ToLower()) {
                    ...
                    default:
                        ...
                        MessageBox.Show("Unknown argument: " + args[0] + "\nValid are : -register, -unregister and -embedding", "ASCOM.Joko.ServoCAT.Telescope", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                        break;
                }
            } else {
                startedByCOM = false;
